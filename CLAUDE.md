...
- **입출금이 들어간 계좌는 id 1·6·9**(나머지는 미입력 → 합산은 securities, 단독 조회만 full).
  ...
  - id 6 Claire 한국개별주: 8건(2026-03-20~2026-07-14, 순 7,093만). **첫 매수(2026-02-26, 562만)에 대응하는 입금이 빠져 있어 현금잔고가 −562만으로 깔린 상태** — 그 탓에 full TWR이 +42.8%로 부풀려진다(누락분 보정 시 +9.5%, securities +9.7%). 사용자 확인 대기 중이니 확인되면 그 1건을 넣을 것.
