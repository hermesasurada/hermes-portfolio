...
- **입출금이 들어간 계좌는 id 1·4·6·9**(나머지는 미입력 → 합산은 securities, 단독 조회만 full).
  ...
  - id 4 Claire 해외주식: 98건(2021-11-09~2026-08-21, 순 2.79억). **2025-11-14부터 현금잔고가 음수(현재 −8,120만)** — 2025-11에 TSLA·RKLB·PL을 8,400만어치 사는데 대응 입금이 없다. 평가액이 6억대라 TWR은 거의 안 흔들리지만(누락 상태 +99.1%, 보정 시 +100.5%) 입금 확인이 필요하다. 참고로 이 계좌의 2026-05-11 −3,306만·2026-06-01 −2,015만 출금은 id 6의 같은 날 입금과 정확히 일치하는 계좌 간 이체다.
