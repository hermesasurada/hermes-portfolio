...
- **입출금이 들어간 계좌는 id 1·4·6·9**(나머지는 미입력 → 합산은 securities, 단독 조회만 full).
  ...
  - id 4 Claire 해외주식: 98건(2021-11-09~2026-08-21, 순 2.79억). 2026-05-11 −3,306만·2026-06-01 −2,015만 출금은 id 6의 같은 날 입금과 정확히 맞물리는 계좌 간 이체다.
    ...
    - 보강 직후 남던 TQQQ 100주·BITO 8주는 사용자 확인으로 마지막 매도 수량을 정정해(2025-05-12 TQQQ 150→250주, 2026-04-09 BITO 1,000→1,008주) 해소했다. **지금은 13종목 전부 잔고=거래합, 평가액 음수 구간도 없다.**
    - 현금잔고는 2025-03-17부터 음수(현재 −7,305만). 2025-02~03에 1.2억이 빠지며 전환됐다 — 또 다른 매도 이력이나 입금이 빠졌을 수 있다(미해결).
