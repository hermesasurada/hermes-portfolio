...
- **입출금이 들어간 계좌는 id 1·4·6·9**(나머지는 미입력 → 합산은 securities, 단독 조회만 full).
  ...
  - id 4 Claire 해외주식: 98건(2021-11-09~2026-08-21, 순 2.79억). 2026-05-11 −3,306만·2026-06-01 −2,015만 출금은 id 6의 같은 날 입금과 정확히 맞물리는 계좌 간 이체다.
    ...
    - **남은 불일치 2건**: AAPL 거래합 −120(매도만 있고 매수 없음 — 같은 120주 매도가 id 1에도 2024-07-12로 들어가 있어 어느 계좌가 맞는지 확인 필요), USD 거래합 +100(매도 기록 없음). 나머지 21종목은 잔고=거래합.
    - 현금잔고는 2025-12-08부터 음수(현재 −3,313만). 보강 전에는 2025-03-17부터 −7,305만이었는데 SSO·O·USD 매도가 들어오며 좁혀졌다. 남은 차이의 대부분은 2026-05-11 id 6으로 보낸 −3,306만 이체다.
