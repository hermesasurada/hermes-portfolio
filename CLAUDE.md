...
- **테마 = '따뜻한 서재'(496e0d8·ed66328)**: 라이트=크림 종이+세피아 잉크+램프 그린 액센트, 다크='밤의 서재'(웜 다크 브라운). 쿨 블루그레이 복귀 금지. 형태 언어=**종이 카드**(은은한 낙하 그림자+보더, 라운드 8/6px, body::before 종이 그레인, 차트 가로선은 점선 괘선) — 뉴모피즘 복귀 금지. 헤딩 세리프는 Noto Serif KR 600 자체 호스팅(타이틀·그룹 라벨·히어로 금액 — 본문·표 숫자는 Pretendard+tabular 유지).
