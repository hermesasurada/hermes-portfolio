...
FISCAL_END_MONTH_OVERRIDES = {
    "NVDA": 3,
    # JPM: 스트레스테스트 뒤 10월 회차부터 인상분을 지급한다 → 10월~익년 7월이 한 배당년도.
    # 자동 판정도 결산월 9월을 찾아내지만, 4월에도 중간 인상이 잦아 사이클이 2회씩 끊기고
    # 한 라벨에 4회를 넘겨 역년으로 통째 폴백한다(같은 1.5달러 네 회차가 2025/2026으로 갈렸다).
    # 오버라이드는 재라벨을 타지 않으므로 회계연도 귀속이 그대로 유지된다.
    "JPM": 9,
}
