...
- Ichimoku bullish clouds use red solid vertical hatching/edges; bearish clouds use blue dashed vertical hatching/edges, with subtle tints for contrast. Touch chart/transaction-marker tooltips require a stationary 450ms hold (10px tolerance), follow the held finger and hide on release/cancel. Quick taps and scrolling do not display tooltips; preserve desktop hover and range dragging.
