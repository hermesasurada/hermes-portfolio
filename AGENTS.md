...
- Keep Ichimoku's original light red/blue vertical-line fills without extra tint, edge strokes or bearish dashes. Touch chart/transaction-marker tooltips require a stationary 450ms hold (10px tolerance), follow the held finger and remain after release until the next touch elsewhere (including another chart location). Quick taps and scrolling do not open tooltips; preserve desktop hover and range dragging.
