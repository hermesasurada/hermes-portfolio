...
- Dividend-history modal and table widths follow actual content, including optional monthly count-column removal. Preserve full amounts/dates, compact padding and horizontal table scrolling on narrow screens; do not restore fixed modal or positional column widths.
