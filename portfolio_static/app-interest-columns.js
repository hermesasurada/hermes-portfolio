...
const INTEREST_COLUMNS = [
  ...
  { key: "perf_3y", width: 64, label: "<span>3년</span><span>CAGR</span>", headClass: "interest-leaf-head", ariaLabel: "3년 연평균 복리수익률",
    cell: (r, group) => `${signedPercentText(r.perf_3y, 1)}` },
  { key: "perf_5y", width: 64, label: "<span>5년</span><span>CAGR</span>", headClass: "interest-leaf-head", ariaLabel: "5년 연평균 복리수익률",
    cell: (r, group) => `${signedPercentText(r.perf_5y, 1)}` },
  { key: "perf_10y", width: 64, label: "<span>10년</span><span>CAGR</span>", headClass: "interest-leaf-head", ariaLabel: "10년 연평균 복리수익률",
