...
const INTEREST_COLUMNS = [
  { key: "logo", width: 40, label: "", headClass: "logo-col interest-leaf-head", ariaHidden: true, cellClass: "logo-cell", always: true,
    cell: (r, group) => `${companyProfileLogo(r)}` },
  ...
  { key: "trade_timing", width: 76, label: "<span>매매 참고</span><span class=\"trade-timing-note\">실험적</span>", headClass: "indicator-head interest-leaf-head trade-timing-col", cellClass: "trade-timing-col",
  ...
  { key: "beta", width: 42, label: "β", headClass: "interest-leaf-head", title: BETA_TOOLTIP,
    cell: (r, group) => `${betaText(r.beta)}` },
  { key: "beta_adj", width: 44, label: "β″", headClass: "interest-leaf-head", title: BETA_ADJ_TOOLTIP,
  ...
  { key: "perf_3y", width: 64, label: "3년", headClass: "interest-leaf-head", ariaLabel: "3년 연평균 복리수익률",
    cell: (r, group) => `${signedPercentText(r.perf_3y, 1)}` },
  { key: "perf_5y", width: 64, label: "5년", headClass: "interest-leaf-head", ariaLabel: "5년 연평균 복리수익률",
    cell: (r, group) => `${signedPercentText(r.perf_5y, 1)}` },
  { key: "perf_10y", width: 64, label: "10년", headClass: "interest-leaf-head", ariaLabel: "10년 연평균 복리수익률",
    cell: (r, group) => `${signedPercentText(r.perf_10y, 1)}` },
